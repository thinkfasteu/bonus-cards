...
import { CardSnapshot } from '../lib/api';
...
const CardPanel: React.FC<CardPanelProps> = ({ card, loading = false, error = null }) => {
  ...
  return (
    <div className="card">
      ...
      <div className="card-body">
        <div className="card-info-grid">
          ...
          <div className="info-row">
            ...
            <span>
              ...
              {daysLeft > 0 && (
                <small className="text-muted ml-8">
                  (in {daysLeft} Tagen)
                </small>
              )}
              {daysLeft <= 0 && (
                <small className="text-danger ml-8">
                  (Abgelaufen)
                </small>
              )}
            </span>
        ...
        {isActionable && (
          <div className="card-action-hint" style={{ marginTop: '16px', padding: '12px', backgroundColor: '#e8f5e8', borderRadius: '4px' }}>
